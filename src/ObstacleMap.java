...
public class ObstacleMap {
     ...
     */
    ObstacleMap(int setRows, int setColumns, int difficulty) {
     ...
     *
     * @return A int array containing coordinates of the non-obstacles [row, column]
     */
    @SuppressWarnings("unused")
     ...
     * @return locations
     */
    int[][] nonObstacleLocations(int startRows, int endRows) {
        boolean[][] checkMap = this.obstacleMap;
     ...
     */
    void setObstacle(int row, int col, boolean setObstacle) {
